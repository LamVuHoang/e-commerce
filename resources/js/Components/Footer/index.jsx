...
export default function index() {
    return (
        <>
            <div className="w-full block bg-white border-t border-gray-200 py-5 md:pb-12 px-5 md:px-12 lg:px-20 xl:px-40 2xl:px-60 flex justify-between items-start my-shadow">
